...
export class Navigation {
   ...
   */
  public registerComponentWithRedux(componentName: string, getComponentClassFunc: ComponentProvider, reduxStore: any): ComponentType<any> {
    return this.componentRegistry.registerComponent(componentName, getComponentClassFunc, reduxStore);
  }

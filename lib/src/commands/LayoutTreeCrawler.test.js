...
describe('LayoutTreeCrawler', () => {
  ...
  it.only('Containers: crawls navigationOptions and converts keys ending with Color', () => {
    const navigationOptions = { someKeyColor: 'red' };
    const node = { type: LayoutTypes.Container, data: { name: 'theContainerName', navigationOptions } };
    uut.crawl(node);

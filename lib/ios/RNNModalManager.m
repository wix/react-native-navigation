...
-(void)removePendingNextModalIfOnTop:(RNNTransitionCompletionBlock)completion {
	...
	RNNNavigationOptions* options = modalToDismiss.getLeafViewController.parentInfo.options;
	...
	if (modalToDismiss == topPresentedVC || [[topPresentedVC childViewControllers] containsObject:modalToDismiss]) {
		...
		modalToDismiss.getLeafViewController.parentInfo.options.animations.dismissModal.enable = NO;
		[self dismissedModal:modalToDismiss];

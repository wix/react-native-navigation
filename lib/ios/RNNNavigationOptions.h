...
@property (nonatomic, strong) NSNumber* topBarSubtitleColor;
...
@property (nonatomic, strong) NSString* topBarSubtitleFontFamily;
...
@property (nonatomic, strong) NSNumber* topBarSubtitleFontSize;

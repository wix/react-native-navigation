...
- (void)applyOptionsOnInit:(RNNNavigationOptions *)options {
	...
	if (@available(iOS 13.0, *)) {
		[viewController setModalInPresentation: [withDefault.disableDismissGesture getWithDefaultValue:NO]];
	}
...
- (void)mergeOptions:(RNNNavigationOptions *)options resolvedOptions:(RNNNavigationOptions *)currentOptions {
	...
	if (options.disableDismissGesture.hasValue) {
		if (@available(iOS 13.0, *)) {
			[viewController setDisableDismissGesture:options.disableDismissGesture.get];
		}
	}

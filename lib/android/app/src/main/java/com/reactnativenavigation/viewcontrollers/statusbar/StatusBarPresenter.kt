...
class StatusBarPresenter private constructor(
    ...
    fun getStatusBarPushAnimation(appearingOptions: Options, defaultOptions: Options): Animator? {
        val statusBarOptions = appearingOptions.copy().withDefaultOptions(defaultOptions).statusBar
        return getStatusBarColorAnimation(statusBarOptions)
    }

    fun getStatusBarPopAnimation(appearingOptions: Options, disappearingOptions: Options, defaultOptions: Options): Animator? {
        val statusBarOptions = appearingOptions.copy().withDefaultOptions(defaultOptions).statusBar
        return getStatusBarColorAnimation(statusBarOptions)
    }

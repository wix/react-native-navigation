...
public class NavigationAnimator {
    ...
    public void animateShowTopBar(final TopBar topBar, final View container) {
        animateShowTopBar(topBar, container, -1 * topBar.getMeasuredHeight(), DECELERATE_INTERPOLATOR, DURATION_TOPBAR);
    }
    ...
    public void animateHideTopBar(final TopBar topBar, final View container) {
        animateHideTopBar(topBar, container, 0, ACCELERATE_INTERPOLATOR, DURATION_TOPBAR);
    }

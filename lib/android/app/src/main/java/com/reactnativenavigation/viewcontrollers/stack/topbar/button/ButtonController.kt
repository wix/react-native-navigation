...
open class ButtonController(activity: Activity,
    ...
    open fun applyColor(toolbar: Toolbar, color: RNNColour) = this.menuItem?.let { presenter.applyColor(toolbar, it, color) }

    open fun applyDisabledColor(toolbar: Toolbar, disabledColour: RNNColour) = this.menuItem?.let { presenter.applyDisabledColor(toolbar, it, disabledColour) }

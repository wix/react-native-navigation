 ...
 */
open class AHBottomNavigation : FrameLayout {
    // Title state
    ...
    private var bottomNavigationBehavior: AHBottomNavigationBehavior<AHBottomNavigation>? = null
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        defaultNotificationElevation =
            resources.getDimensionPixelSize(R.dimen.bottom_navigation_notification_elevation)
        activePaddingTop =
        ...
        fill(
            ...
            ContextCompat.getColor(
                context,
                R.color.colorBottomNavigationInactiveColored
            )
        )
            ...
            try {
                ...
                AHHelper.map(
                    ...
                    ta.getColor(
                        ...
                        ContextCompat.getColor(
                            context,
                            R.color.colorBottomNavigationAccent
                        )
                    )
                }
                AHHelper.map(
                ...
                AHHelper.map(
                    ...
                    ta.getColor(
                        ...
                        ContextCompat.getColor(
                            context,
                            R.color.colorBottomNavigationDisable
                        )
                    )
                }
                ...
                colored =
                    ta.getBoolean(R.styleable.AHBottomNavigationBehavior_Params_colored, false)
            } finally {
                ta.recycle()
            }
        }
        ...
        notificationActiveMarginTop =
            resources.getDimension(R.dimen.bottom_navigation_notification_margin_top_active).toInt()
        ...
        val params =
            ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, bottomNavigationHeight)
        layoutParams = params
    }
    ...
    protected open fun createItems() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            val backgroundLayoutParams =
                LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, calculateHeight(layoutHeight))
    ...
    private fun calculateHeight(layoutHeight: Int): Int {
        ...
        var _layoutHeight = layoutHeight
        if (hasImmersive() && translucentNavigation) _layoutHeight += navigationBarHeight
    ...
    private fun createClassicItems(linearLayout: LinearLayout) {
        ...
        for (i in items.indices) {
            ...
            val container = view.findViewById<FrameLayout>(R.id.bottom_navigation_container)
            ...
            val notification = view.findViewById<AHTextView>(
            ...
            if (updateStyle) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    notification.elevation =
                        (if (notificationItem.isDot) 0 else defaultNotificationElevation).toFloat()
                }
                ...
                if (notificationBackgroundDrawable != null) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        val drawable = notificationBackgroundDrawable!!.constantState!!
                            .newDrawable()
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        ...
                        notification.setBackgroundDrawable(
                            AHHelper.getTintDrawable(
                                defaultDrawable,
                                currentBackgroundColor,
                                forceTint

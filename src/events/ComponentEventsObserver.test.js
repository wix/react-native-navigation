...
describe('ComponentEventsObserver', () => {
    ...
    it(`bindComponent expects a component with componentId`, () => {
        const screen1 = (0, react_native_1.render)(React.createElement(SimpleScreen, null));
        const instance1 = screen1.UNSAFE_getByType(SimpleScreen).instance;
        expect(() => uut.bindComponent(instance1)).toThrow('');
        const screen2 = (0, react_native_1.render)(React.createElement(SimpleScreen, { componentId: 123 }));
        const instance2 = screen2.UNSAFE_getByType(SimpleScreen).instance;
        expect(() => uut.bindComponent(instance2)).toThrow('');
    });
    it(`bindComponent accepts an optional componentId`, () => {
        const screen = (0, react_native_1.render)(React.createElement(UnboundScreen, null));
        const instance = screen.UNSAFE_getByType(UnboundScreen).instance;
        uut.bindComponent(instance, 'myCompId');
    ...
    it(`bindComponent should use optional componentId if component has a componentId in props`, () => {
        const screen = (0, react_native_1.render)(React.createElement(UnboundScreen, { componentId: 'doNotUseThisId' }));
        const instance = screen.UNSAFE_getByType(UnboundScreen).instance;
        uut.bindComponent(instance, 'myCompId');
        expect(screen.toJSON()).toBeDefined();
        uut.notifyComponentDidAppear({
    ...
    it(`bindComponent notifies listeners by componentId on events`, () => {
        const screen = (0, react_native_1.render)(React.createElement(BoundScreen, { componentId: 'myCompId' }));
        expect(screen.toJSON()).toBeDefined();
    ...
    it(`componentDidAppear should receive component props from store`, () => {
        ...
        (0, react_native_1.render)(React.createElement(BoundScreen, { componentId: event.componentId }));
    ...
    it(`doesnt call other componentIds`, () => {
        (0, react_native_1.render)(React.createElement(BoundScreen, { componentId: 'myCompId' }));
        uut.notifyComponentDidAppear({
            componentId: 'other',
            componentName: 'doesnt matter',
            componentType: 'Component',
    ...
    it(`doesnt call unimplemented methods`, () => {
        const screen = (0, react_native_1.render)(React.createElement(SimpleScreen, { componentId: 'myCompId' }));
        const instance = screen.UNSAFE_getByType(SimpleScreen).instance;
        expect(instance.componentDidAppear).toBeUndefined();
        uut.bindComponent(instance);
        uut.notifyComponentDidAppear({
            componentId: 'myCompId',
            componentName: 'doesnt matter',
            componentType: 'Component',
    ...
    it(`returns unregister fn`, () => {
        (0, react_native_1.render)(React.createElement(BoundScreen, { componentId: '123' }));
        uut.notifyComponentDidAppear({
            componentId: '123',
            componentName: 'doesnt matter',
            componentType: 'Component',
    ...
    it(`supports multiple listeners with same componentId`, () => {
        const screen1 = (0, react_native_1.render)(React.createElement(SimpleScreen, { componentId: 'myCompId' }));
        const screen2 = (0, react_native_1.render)(React.createElement(SimpleScreen, { componentId: 'myCompId' }));
        const instance1 = screen1.UNSAFE_getByType(SimpleScreen).instance;
        const instance2 = screen2.UNSAFE_getByType(SimpleScreen).instance;

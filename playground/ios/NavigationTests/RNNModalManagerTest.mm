...
- (void)testDismissMultipleModalsInvokeDelegateWithCorrectParameters {
	((MockViewController *)UIApplication.sharedApplication.delegate.window.rootViewController)
		.presentedViewController = [MockViewController new];
...
- (void)testTopPresentedVC_shouldNotReturnModalThatIsBeingDismissed {
	UIApplication.sharedApplication.delegate.window.rootViewController =
	[UIViewController new];
	UIViewController *beingDismissedModal = [OCMockObject
											 partialMockForObject:[UIViewController new]];

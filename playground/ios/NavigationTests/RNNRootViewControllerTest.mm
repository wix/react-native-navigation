...
- (void)testTopBarBlur_default {
    __unused RNNStackController *nav = [self createNavigationController];
    [self.uut viewWillAppear:false];
    XCTAssertNil([self.uut.navigationController.navigationBar viewWithTag:78264802]); // 78264802 comes from BLUR_TOPBAR_TAG in UINavigationController+RNNOptions
}
...
- (void)testTopBarBlur_true {
    ...
    __unused RNNStackController *nav = [self createNavigationController];
    [self.uut viewWillAppear:false];
    XCTAssertNotNil([self.uut.navigationController.navigationBar viewWithTag:78264802]); // 78264802 comes from BLUR_TOPBAR_TAG in UINavigationController+RNNOptions
}

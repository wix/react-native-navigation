const testIDs = {
  ...
  OPEN_LEFT_SIDE_MENU_ABOVE_CONTENT_BTN: 'OPEN_LEFT_SIDE_MENU_ABOVE_CONTENT_BTN',
  OPEN_RIGHT_SIDE_MENU_ABOVE_CONTENT_BTN: 'OPEN_RIGHT_SIDE_MENU_ABOVE_CONTENT_BTN',

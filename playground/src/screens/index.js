...
function registerScreens() {
  ...
  Navigation.registerComponent(Screens.CocktailsListScreen, () =>
    require('./sharedElementTransition/CocktailsListScreen')
  );
  Navigation.registerComponent(Screens.CocktailsListMasterScreen, () =>
    require('./splitView/CocktailsListMasterScreen')
  );
  Navigation.registerComponent(
    Screens.EventsOverlay,
    () => require('./StaticLifecycleOverlay').StaticLifecycleOverlay
  );
  ...
  Navigation.registerComponent(Screens.PIPScreen, () => require('./PIPScreen'));

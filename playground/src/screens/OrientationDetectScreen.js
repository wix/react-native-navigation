  ...
  render() {
    return (
      <View style={styles.root} onLayout={this.detectHorizontal}>
        ...
        {this.state.horizontal ? <Text style={styles.footer} testID={testIDs.LANDSCAPE_ELEMENT}>Landscape</Text> : <Text style={styles.footer} testID={testIDs.PORTRAIT_ELEMENT}>Portrait</Text>}
      </View>
    );
  }

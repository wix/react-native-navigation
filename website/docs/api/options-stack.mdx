...
### `leftButtonColor`
:::warning Deprecation warning
This option is currently deprecated and will be removed in a future release. Please use the [OptionProcessor](style-theme.mdx) option instead.
:::
...
### `rightButtonColor`
:::warning Deprecation warning
This option is currently deprecated and will be removed in a future release. Please use the [OptionProcessor](../docs/style-theme.mdx) option instead.
:::

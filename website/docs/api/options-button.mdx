...
Set the button text font FontFamily.
...
Set the button text font weight. Ignors fontFamily and use the iOS system fonts instead.

| Type                                                                                           | Required | Platform |
| ---------------------------------------------------------------------------------------------- | -------- | -------- |
| enum('regular', 'bold', 'thin', 'ultraLight', 'light', 'medium', 'semibold', 'heavy', 'black') | No       | iOS      |

...
A Boolean value that indicates whether the BottomTabs should be translucent.
...
On Android, the option is experimental and should be enabled using a native feature-toggle called `TAB_BAR_TRANSLUCENCE` (pass it to the `NavigationApplication` c'tor).

...
Recommended: Read about Bottom Tabs in the [Bottom Tabs Guide](../docs/docs-bottomTabs.mdx). For React tab items, see [Custom bottom tabs](../docs/docs-customBottomTabs.mdx).

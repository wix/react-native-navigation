...
If you want to dig right into it, start with [installing](/react-native-navigation/docs/installing) the library. If you're just looking around, we suggest checking out [basic navigation](/react-native-navigation/docs/basic-navigation) first.

...
```javascript
Navigation.setRoot({ // An example; showModal() and push() also support this
  root: {
    bottomTabs: {
      options: {
        layoutStyle: 'compact',
        ...
        // optional:
        blurRadius: 2.0, // Custom radius
        backgroundColor: 'rgba(50, 50, 50, 0.4)', // Semi-transparent color
        elevation: 1, // Soft a surrounding shadow effect (i.e. the elevation)
      },
      children: [
        // ...
      ],

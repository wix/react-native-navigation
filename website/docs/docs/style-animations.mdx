...
* `'back'`: Slowly back up, then accelerate towards the destination.
* `'ease'`: Use a cubic ease out function to smoothly animate towards the destination, the decelerate slowly to settle. (See: [EaseOutCubic](https://easings.net/#easeOutCubic))

...
```tsx file=./third-party-react-context/counter-context.tsx
```
...
```tsx file=./third-party-react-context/register-screen.tsx
```
...
```tsx file=./third-party-react-context/context-consumer.tsx
```

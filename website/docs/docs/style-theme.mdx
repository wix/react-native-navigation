...
Dark mode support for navigation UI components can be done via colors, perferably setting a Theme in the default options, as in the example below.

The trigger for the change is system wide Dark Mode toggle.
